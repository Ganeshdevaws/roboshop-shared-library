        ...
        stages {
            ...
            stage('Docker Build') {
                steps {
                    script{
                        sh """
                            docker build -t ganesh450/${component}:${packageVersion} .
                        """
                    }
                }
            }
                ...
                steps {
                    ...
                    withCredentials([usernamePassword(credentialsId: 'docker-auth', usernameVariable: 'USERNAME', passwordVariable: 'PASSWORD')]) {
                        ...
                        sh """
                            ...
                            docker push ganesh450/${component}:${packageVersion}
                        """
                    }
                        // sh """
            ...
            stage('ECR Push'){
                steps{
                    script{
                        ...
                        docker tag ganesh450/${component}:${packageVersion} ${ACCOUNT_ID}.dkr.ecr.${REGION}.amazonaws.com/${component}:${packageVersion}
